...
This reference is for ESP32-family boards. The WindowActuator device is an ESP8266 Wemos D1 mini;
use `esp8266-firmware` and the pin assignments in `freeze/main.py` for that project.
